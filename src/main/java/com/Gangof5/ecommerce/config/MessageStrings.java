package com.Gangof5.ecommerce.config;
...
public class MessageStrings {
    ...
    public static final String USER_LOGOUT = "Log out successful!";
    public static final String CLAIM_RESOLVED = "Claim is resolved with success!";
}
